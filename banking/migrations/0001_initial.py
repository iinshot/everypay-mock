        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        decimal_places=2, max_digits=19, verbose_name="Сумма транзакции"
                    ),
                ),
                (
                    "value_date_time",
                ...
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=300, verbose_name="Назначение платежа"
                    ),
                ),
                (
                    "debtor_name",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Название плательщика"
                    ),
                ),
                (
                    "debtor_account",
                ...
                (
                    "creditor_name",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Название получателя"
                    ),
                ),
                (
                    "creditor_account",
                    models.CharField(
                        blank=True, max_length=34, verbose_name="Номер счета получателя"
                    ),
                ),
                (
                    "currency",

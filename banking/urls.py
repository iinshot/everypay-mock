...
router = Router("api/", [
    ...
    path("accounts/<uuid:account_id>/", views.AccountDetailController.as_view(), name="account-detail"),
    path("statements/<uuid:account_id>/", views.StatementsController.as_view(), name="statements"),
    path(

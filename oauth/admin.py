...
from .models import OAuthClient, ThirdPartyCode, PKCEAuthorizationCode, AccessToken, RefreshToken
...
class AccessTokenAdmin(admin.ModelAdmin):
    list_display = ("client", "company", "third_party", "created_at", "expires_at", "is_revoked")
